...
See [overview.md](./overview.md) for details on this quirk and other client ergonomics issues. Always verify the
request model constructor signature before using — intuitive Python names will **not** work.

## Contents

- [Pattern 1: Systems Grid Column Report](#pattern-1-systems-grid-column-report)
- [Pattern 2: Test Data Analysis](#pattern-2-test-data-analysis)
- [Pattern 3: Scalar Output](#pattern-3-scalar-output)
