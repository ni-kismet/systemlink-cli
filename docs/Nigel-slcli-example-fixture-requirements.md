...
| Feeds and deployment states | The generic example provisioner uploads feed packages and populates deployment-state feed/package inventory; owned states are refreshed idempotently, but live acceptance queries still need verification. |
